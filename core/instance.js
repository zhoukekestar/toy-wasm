import { FuncTypeNode, CodeNode, UnreachableInstrNode, NopInstrNode, BlockInstrNode, LoopInstrNode, IfInstrNode, BrInstrNode, BrIfInstrNode, BrTableInstrNode, ReturnInstrNode, CallInstrNode, CallIndirectInstrNode, GlobalGetInstrNode, GlobalSetInstrNode, I32LoadInstrNode, I32StoreInstrNode, I32ConstInstrNode, I32EqzInstrNode, I32LtSInstrNode, I32GeSInstrNode, I32GeUInstrNode, I32AddInstrNode, I32RemSInstrNode, LocalGetInstrNode, LocalSetInstrNode, LocalTeeInstrNode, GlobalTypeNode, } from "./node.js";
...
class CallIndirectInstruction extends Instruction {
    ...
    invoke(context) {
        if (context.debug)
            console.warn("invoke call_indirect");
...
class GlobalGetInstruction extends Instruction {
    ...
    invoke(context) {
        if (context.debug)
            console.warn("invoke global.get");
...
class GlobalSetInstruction extends Instruction {
    ...
    invoke(context) {
        if (context.debug)
            console.warn("invoke global.set");
        const global = context.globals[this.#globalIdx];
        if (!global.mutable) {
...
class JsFuncInstruction extends Instruction {
    ...
    invoke(context) {
        if (context.debug)
            console.warn(`invoke js function: ${this.#func.name}`);
        // invoke
